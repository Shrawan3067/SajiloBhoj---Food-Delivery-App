        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center space-x-4 mb-3 lg:mb-0">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">{order.restaurant.cuisine}</p>
            </div>
          </div>
            ...
            <div className="space-y-3">
              ...
              {order.deliveryPartner && (
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">Delivery by {order.deliveryPartner}</span>
                </div>
              )}
              {order.deliveryDate && (
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">
                    Delivered on {formatDate(order.deliveryDate)} at {formatTime(order.deliveryDate)}
                  </span>
                </div>
              )}
            </div>
