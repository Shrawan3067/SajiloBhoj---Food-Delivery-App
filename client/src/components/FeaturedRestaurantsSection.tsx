    ...
    <section className="py-8 bg-gray-50 relative">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-[19px] md:text-2xl font-bold text-left">
        ...
        <div className="flex justify-center space-x-2 mt-4">
          {[1, 2, 3].map((dot) => (
            <div
              key={dot}
              className="w-2 h-2 bg-gray-300 rounded-full hover:bg-orange-500 cursor-pointer"
            ></div>
          ))}
        </div>
        ...
        <div className="text-center mt-8">
          <button
            onClick={() => window.location.assign("/restaurant-list")}
