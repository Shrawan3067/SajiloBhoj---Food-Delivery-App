  ...
  const faqCategories = [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: 'Go to Profile → Settings → Change Password. Enter your current password and set a new one. If you forgot your password, use the "Forgot Password" option on the login screen.'
        },
        {
          id: 'acc3',
          question: 'How to update my delivery address?',
          answer: 'Navigate to Profile → My Addresses → Add New Address or edit existing ones. You can save multiple addresses for quick selection.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: 'Go to My Orders → Select the ongoing order → View Live Tracking. You can see the real-time status and estimated delivery time.'
        },
        {
          id: 'ord2',
          question: 'What is the delivery time?',
          answer: 'Delivery time varies from 20-45 minutes depending on restaurant preparation time, distance, and traffic conditions. You can see the estimated time before placing your order.'
        },
        {
          id: 'ord3',
          question: 'Can I modify or cancel my order?',
          answer: 'You can modify or cancel your order within 1 minute of placing it. After that, please contact the restaurant directly via the app.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: 'We accept credit/debit cards, net banking, UPI, wallets (Paytm, PhonePe, Google Pay), and cash on delivery.'
        },
        {
          id: 'pay2',
          question: 'How long do refunds take?',
          answer: 'Refunds to bank accounts take 5-7 business days. UPI refunds are processed within 24 hours. Wallet refunds are instant.'
        },
        {
          id: 'pay3',
          question: 'Why was my payment declined?',
          answer: 'Payment may decline due to insufficient funds, incorrect details, bank server issues, or security restrictions. Try another payment method or contact your bank.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: 'All delivery partners wear masks, use hand sanitizers, maintain social distancing, and follow contactless delivery protocols.'
        },
        {
          id: 'safe2',
          question: 'How are restaurants ensuring food safety?',
          answer: 'Partner restaurants follow strict hygiene protocols, regular health checks for staff, and temperature monitoring.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: 'Visit our website and click "Partner with Us" → Restaurant Partner → Fill the form. Our team will contact you within 48 hours.'
        },
        {
          id: 'res2',
          question: 'What are the commission charges?',
          answer: 'Commission varies based on location and restaurant type. Our partnership team will provide detailed pricing during onboarding.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: 'Add items to cart → Proceed to checkout → Apply Promo Code section → Enter code → Apply. Discount will be reflected in total.'
        },
        {
          id: 'off2',
          question: 'Why is my promo code not working?',
          answer: 'Check if the code has expired, meets minimum order value, is valid for the restaurant, and hasn\'t exceeded usage limit.'
        }
      ]
    }
  ];
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {popularIssues.map((issue) => (
              ...
              >
                <div className={`${issue.color} w-12 h-12 rounded-xl flex items-center justify-center mb-4`}>
                  {issue.icon}
                </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {helpTopics.map((topic) => (
              <div key={topic.id} className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h3 className="font-bold text-xl mb-4">{topic.title}</h3>
                <ul className="space-y-3">
                  {topic.items.map((item, index) => (
                    <li key={index} className="flex items-center gap-2 text-gray-700 hover:text-orange-500 cursor-pointer">
            ...
            {faqCategories.map((category) => (
              <div key={category.id} className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-3">
                  {category.faqs.slice(0, 2).map((faq) => (
                    <div key={faq.id}>
                      <div 
                        className="flex justify-between items-center cursor-pointer py-2"
                        onClick={() => toggleFaq(faq.id)}
                      >
                        <span className="font-medium text-gray-700 hover:text-orange-500">{faq.question}</span>
                        {faqOpen === faq.id ? <FiChevronUp /> : <FiChevronDown />}
                      </div>
                      {faqOpen === faq.id && (
                ...
                {category.faqs.length > 2 && (
                  <button className="mt-4 text-orange-500 font-medium text-sm flex items-center gap-1">
                    View {category.faqs.length - 2} more questions <FiChevronRight />
                  </button>
                )}
              </div>
            ))}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">10 AM - 10 PM (Phone)</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="hover:text-orange-500 cursor-pointer">Cancellation Policy</li>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="hover:text-orange-500 cursor-pointer">Customer Reviews</li>
                <li className="hover:text-orange-500 cursor-pointer">Rate Your Experience</li>
                <li className="hover:text-orange-500 cursor-pointer">Feedback & Suggestions</li>
                <li className="hover:text-orange-500 cursor-pointer">Community Guidelines</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="hover:text-orange-500 cursor-pointer">Video Tutorials</li>
                <li className="hover:text-orange-500 cursor-pointer">User Guide</li>
                <li className="hover:text-orange-500 cursor-pointer">Troubleshooting</li>
                <li className="hover:text-orange-500 cursor-pointer">FAQ Archive</li>
              </ul>
            </div>
          </div>
        </section>
      ...
      <div className="bg-gray-800 text-white py-6">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-300">
            Need immediate assistance? Call us at <span className="font-bold">1800-123-4567</span> or chat with us 24/7
          </p>
