  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50">
      ...
      <div className="sticky top-[80px] z-40">
        {/* Mobile Horizontal Scrollable Navigation - Sticky at top */}
                    ...
                    {menuItems.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-2 px-3 py-2 rounded-lg border transition-all duration-300 font-semibold shrink-0 text-sm whitespace-nowrap ${
                            activeTab === item.id
