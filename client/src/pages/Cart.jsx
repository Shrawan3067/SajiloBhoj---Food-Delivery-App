...
export default function Cart() {
  const { cart, removeFromCart, clearCart, updateQuantity, totalPrice, totalItems } = useContext(CartContext);
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {cart.length === 0 ? (
          ...
          <div className="text-center py-16 bg-white rounded-3xl shadow-lg">
            ...
            <h2 className="text-2xl font-bold text-gray-700 mb-2">Your cart feels lonely</h2>
          ...
          <div className="grid max-w-3xl grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {Object.entries(groupedCart).map(([restaurantId, items]) => (
                <div key={restaurantId} className="bg-white rounded-3xl shadow-lg overflow-hidden">
                  {/* Restaurant Header */}
                  <div className="bg-gradient-to-r from-orange-50 to-red-50 p-4 border-b">
                    <div className="flex items-center gap-3">
                      <IoRestaurant className="text-orange-500 text-xl" />
                      <div>
                        <h3 className="font-bold text-gray-900">Restaurant #{restaurantId}</h3>
                        <p className="text-sm text-gray-600">Free delivery above ₹299</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between text-gray-600">
                    <span className="flex items-center gap-2">
                      ...
                      Delivery Fee
                      {deliveryFee === 0 && (
                        <span className="bg-green-100 text-green-600 px-2 py-1 rounded-full text-xs">FREE</span>
                      )}
                    </span>
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-100 border border-green-200 rounded-xl p-3 mb-4">
                    <div className="flex items-center gap-2 text-green-700">
                      ...
                      <span className="text-sm font-semibold">
                        Add ₹{(299 - totalPrice).toFixed(2)} more for FREE delivery!
                      </span>
                    </div>
                  </div>
                )}
