      ...
      <section className="bg-gradient-to-r from-orange-500 to-red-500 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-orange-500 transition duration-300">
              Learn More
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Sign up with your restaurant details</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Onboard</h3>
              <p className="text-gray-600">Complete the verification process</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              <div className="bg-orange-500 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">4</div>
              <h3 className="text-lg font-semibold mb-2">Grow</h3>
              <p className="text-gray-600">Expand your business</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="flex items-center mb-4">
                <FaMotorcycle className="text-orange-500 text-3xl mr-4" />
        ...
        <div className="max-w-7xl container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="text-orange-500 text-2xl mb-4">"</div>
              <p className="text-gray-600 mb-4">
                As a delivery partner, I enjoy the flexibility and earning potential. The weekly payments are always on time.
              </p>
              <div className="font-semibold">- Priya Sharma, Delivery Partner</div>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="text-orange-500 text-2xl mb-4">"</div>
              <p className="text-gray-600 mb-4">
