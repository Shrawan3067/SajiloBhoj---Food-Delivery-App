  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const orderData = {
        ...
        finalAmount: 456,
        deliveryAddress:
          "123 Main Street, Apartment 4B, Near Central Park, Mumbai - 400001",
        deliveryPartner: {
          name: "Rahul Kumar",
    ...
    const intervalTimer = setInterval(() => {
      setTimeLeft((prev) => {
        if (prev <= 1) {
          setOrder((prevOrder) =>
            prevOrder ? { ...prevOrder, status: "delivered" } : null,
          );
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Getting your delicious food details ready...
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 flex items-center justify-center p-4">
        <div className="text-center bg-white rounded-3xl shadow-xl p-8 max-w-md">
          <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <FaBag className="text-4xl text-gray-400" />
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-[22px] md:text-3xl font-bold mb-1">
                  Track Your Order
                </h1>
            ...
            <div className="text-right">
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl md:p-3 p-2 text-center">
                ...
                <div className="text-orange-200 md:text-sm text-[12px]">
                  minutes left
                </div>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 -mt-4">
        <div className="bg-white rounded-3xl shadow-xl p-6 mb-6">
          <div className="flex md:flex-row flex-col items-center justify-between">
            <div className="flex items-center gap-4">
              <div
                className={`p-4 rounded-2xl ${isDelivered ? "bg-green-100 text-green-600" : "bg-orange-100 text-orange-600"}`}
              >
                {isDelivered ? (
                  <FaCheckCircle className="text-3xl" />
                ) : (
                  <FaBike className="text-3xl" />
                )}
              </div>
              <div>
                <h3
                  className={`md:text-2xl text-[18px] font-bold ${isDelivered ? "text-green-600" : "text-orange-600"}`}
                >
                  {isDelivered
                    ? "Delivered Successfully!"
                    : `Delivery in ${timeLeft} minutes`}
                </h3>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 mb-6">
          <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
            <FaClock className="text-orange-500" /> Order Journey
          </h2>
            ...
            <div className="space-y-8">
              {statusSteps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`relative z-10 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-500 ${isCompleted ? "bg-gradient-to-br from-orange-500 to-red-500 scale-110" : "bg-gray-100 scale-100"}`}
                    >
                      <Icon
                        className={`text-2xl ${isCompleted ? "text-white" : "text-gray-400"}`}
                      />
                      {isCurrent && !isLast && (
                    ...
                    <div className="flex-1 pt-2">
                      <div className="flex items-center gap-3 mb-1">
                        <p
                          className={`text-lg font-bold ${isCompleted ? "text-gray-900" : "text-gray-500"}`}
                        >
                          {step.label}
                        </p>
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center gap-2 text-sm text-green-600">
                                    ...
                                    {order.deliveryPartner.deliveries}{" "}
                                    deliveries
                                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-3xl shadow-xl p-6">
            <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
              <IoRestaurant className="text-orange-500" /> Restaurant Details
            </h3>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 mb-6">
          <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
            <FaShoppingBag className="text-purple-500" /> Order Summary
          </h3>
          <div className="space-y-4">
